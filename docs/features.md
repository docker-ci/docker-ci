...
Probably the best way to get along with docker-ci is to try it right way. It's simple and easy. Check out [this](/how-to-launch-node-application-with-mongodb-using-docker-ci] tutoria)
